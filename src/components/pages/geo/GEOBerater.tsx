...
export default function GEOBerater() {
  ...
  return (
    <div>
      ...
      <section className="pt-24 px-4 lg:p-32 lg:pb-48 relative lg:bg-custom-white">
      ...
      <section className="mt-24 mx-4 lg:m-0 lg:px-32 lg:bg-custom-white">
      ...
      <section className="mx-4 mt-24 lg:mx-32 lg:mt-32">
        ...
        <div className="lg:mx-8 lg:m-0 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          {sections.slice(0, 4).map((s, index) => (
            <section key={index} className="flex flex-col pt-8">
              <div className="h-full bg-custom-white p-4 lg:p-8 rounded">
      ...
      <section className="px-4 mt-24 lg:px-32 lg:mt-32">
        <div className="lg:max-w-2/3">
          <h2 className="lg:!text-3xl/10 tracking-wide font-semibold">
