export default function Privacy() {
  return (
    <div className="m-8 lg:m-16">
      ...
      <div>
        <h2 className="mt-4">1. Datenschutz auf einen Blick</h2>
        <div>
          <h2 className="mt-4">Allgemeine Hinweise</h2>
          <p>
        ...
        <h2 className="mt-4">Datenerfassung auf dieser Website</h2>
        <div>
          <h2 className="mt-4">
        ...
        <div>
          <h2 className="mt-4">Wie erfassen wir Ihre Daten?</h2>
          <p>
        ...
        <div>
          <h2 className="mt-4">Wofür nutzen wir Ihre Daten?</h2>
          <p>
        ...
        <div>
          <h2 className="mt-4">Analyse-Tools und Tools von Drittanbietern</h2>
          <p>
      ...
      <div>
        ...
        <div>
          <h2 className="mt-4">Datenschutz</h2>
          <p>
        ...
        <div>
          <h2 className="mt-4">Hinweis zur verantwortlichen Stelle</h2>
          <p>
        ...
        <div>
          <h2 className="mt-4">Speicherdauer</h2>
          <p>
        ...
        <div>
          <h2 className="mt-4">Empfänger von personenbezogenen Daten</h2>
          <p>
          ...
          <p>
            ...
            wir gesetzlich hierzu verpflichtet sind (z. B. Weitergabe von Daten
            ...
            weiter. Im Falle einer gemeinsamen Verarbeitung wird ein Vertrag
        ...
        <div>
          <h2 className="mt-4">Recht auf Datenübertragbarkeit</h2>
          <p>
        ...
        <div>
          <h2 className="mt-4">Auskunft, Berichtigung und Löschung</h2>
          <p>
        ...
        <div>
          <h2 className="mt-4">Recht auf Einschränkung der Verarbeitung</h2>
          <p>
      ...
      <div>
        <h2 className="mt-4">4. Datenerfassung auf dieser Website</h2>
        <div>
          <h2 className="mt-4">Kontaktformular</h2>
          <p>
        ...
        <div>
          <h2 className="mt-4">Anfrage per E-Mail, Telefon oder Telefax</h2>
          <p>
            ...
            DSGVO) sofern diese abgefragt wurde; die Einwilligung ist jederzeit
            widerrufbar.
          </p>
          <p>
      ...
      <div>
        <h2 className="mt-4">5. Plugins und Tools</h2>
        <p>YouTube</p>
        <p>
        ...
        <p>https://www.dataprivacyframework.gov/participant/5780</p>
      </div>
    </div>
  );
}
